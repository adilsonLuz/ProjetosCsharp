...
namespace Projeto_Vendas_FATEC.br.com.pdv.dao
{
    public class FuncionarioDAO
    {
        ...
        #region Método para efeturar o login
        public void efetuarLogin(String email, string senha)
        {
            try
            {
                //1 passo criar o comando sql
                string sql = @"select * from TB_Funcionarios where Ds_Email = @email and Ds_Senha = @senha";
                ...
                if (dr.Read())
                {
                    ...
                    //fez login
                    //verificando nivel de acesso e usuario
                    string nivel = dr.GetString("Ds_NivelAcesso");
                    string nome = dr.GetString("Nm_Funcionario");                    

                    MessageBox.Show("Bem vindo ao Sistema: " + nivel);
                    telamenu.lbLogado.Text = dr.GetString("Nm_Funcionario");
                    ...
                    {
                        telamenu.menu_historicoVendas.Visible = false;
